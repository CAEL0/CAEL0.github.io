...
검은 점들과 흰 점들을 직선 하나로 분리할 수 있는 것은 검은 점들의 볼록 껍질과 흰 점들의 볼록 껍질이 disjoint하면서 포함 관계가 아닌 것과 동치이다.

두 볼록 껍질이 disjoint한 것은 모든 (검은 점들의 볼록 껍질의 한 변, 흰 점들의 볼록 껍질의 한 변) 쌍에 대해, 두 변이 서로 교차하지 않음과 동치이다.
